export default {
  brand: {
    name: 'إس بي إل زون',
    tagline: 'تغطية مستقلة للدوري السعودي للمحترفين',
  },
  nav: {
    home: 'الرئيسية',
    news: 'الأخبار',
  ...
  footer: {
    about: 'عن الموقع',
    aboutText:
      'إس بي إل زون هو منشور إعلامي مستقل لمشجعي الدوري السعودي للمحترفين. الموقع غير تابع أو معتمد رسمياً من الدوري السعودي للمحترفين.',
    disclaimer: 'تغطية مستقلة، وليست منشوراً رسمياً للدوري السعودي للمحترفين.',
